...
import 'package:facebook_clone/models/story_models.dart';
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextButton(onPressed: (){}, child: Text('Add to Story',style: TextStyle(
                          fontSize: 20.0,
                          color: Colors.black,
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    bottom: 10.0,
                    left: 10.0,
                    child: Text(storyData[i].userName,style: TextStyle(
                      color: Colors.white,
                      fontSize: 20.0,
                      fontWeight: FontWeight.bold
                    ),)
